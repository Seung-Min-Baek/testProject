...
public class java_클래스개념익히기_3131 {
	public static void main(String[] args) {
		...
		System.out.println("클래스 선언 방법은 [접근 제어자] [final : abstract] class 클래스이름 { ... } 과 같은 형식입니다.");

		System.out.println("사람을 객체로 표현 했을 때, 사람의 이름, 나이, 취미 같은 것들은 멤버변수 라고 할 수 있습니다.");

		System.out.println("사람을 객체로 표현 했을 때, 자기 소개를 한다, 공부를 한다 같은 것들은 멤버메서드 라고 할 수 있습니다.");
		...
		System.out.println("생성자는 객체를 생성할때 실행되는 메서드입니다. new 키워드와 함께 호출되며 클래스 이름과 동일합니다.");
